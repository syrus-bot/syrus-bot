...
module.exports = class extends Language {
    ...
    constructor(...args) {
        ...
        this.language = {
            ...
            COMMAND_MUSIC_QUEUED_TRACK: "Track queued",
            COMMAND_MUSIC_QUEUE_FINISHED_TITLE: "Finished playing!",
            COMMAND_MUSIC_QUEUE_FINISHED_DESCR: "Play something else or use the disconnect command to make the bot leave the voice channel.",
            COMMAND_MUSIC_QUEUE_NOT_FOUND: "No Tracks Found",
            COMMAND_MUSIC_TRACK_START: "Now playing..",
            COMMAND_MUSIC_NOW_PLAYING: "Currently playing",
            COMMAND_MUSIC_LENGTH: "Time",
            COMMAND_MUSIC_REQUESTER: "Requested By",
            COMMAND_MUSIC_NOT_PLAYING: "I'm not playing any music yet.",
            COMMAND_MUSIC_STOPPED: "Stopped Track",
            COMMAND_MUSIC_SKIPPED: "Skipped Track",
            COMMAND_MUSIC_PAUSE: "Paused Player",
            COMMAND_MUSIC_PAUSED: "Player already paused!",
            COMMAND_MUSIC_RESUME: "Resumed Player",
            COMMAND_MUSIC_UNPAUSED: "Player already unpaused!",
        };
    }

    async init() {
        this.client.console.debug(`Loaded ${this.name} Language `);
    }
